    ...
    <main className="page-shell">
      ...
      <section className="section-padding" style={{ marginTop: '40px' }}>
        <div className="container" style={{ maxWidth: '800px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '2.5rem', lineHeight: 1.7, fontSize: '1.05rem', color: 'rgba(255, 255, 255, 0.85)' }}>
            ...
            <section>
              <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#fff' }}>2. Information Collection & Usage</h2>
              ...
              <h3 style={{ fontSize: '1.2rem', marginBottom: '0.5rem', marginTop: '1.5rem', color: '#fff' }}>Website Analytics (Google Analytics 4)</h3>
              <p>
            ...
            <section>
              <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#fff' }}>3. Third-Party Services</h2>
              <p>
            ...
            <section>
              <h2 style={{ fontSize: '1.5rem', marginBottom: '1rem', color: '#fff' }}>4. Your Rights</h2>
              <p>
            ...
            <section style={{ marginTop: '2rem', padding: '2rem', background: 'rgba(255,255,255,0.03)', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.05)' }}>
              <h2 style={{ fontSize: '1.25rem', marginBottom: '0.5rem', color: '#fff' }}>Contact Information</h2>
              <p style={{ margin: 0 }}>
                If you have any questions or concerns, please reach out at: <br/>
                <a href="mailto:ckyong@kitabuild.com" style={{ color: '#fff', textDecoration: 'underline', textUnderlineOffset: '4px' }}>ckyong@kitabuild.com</a>
              </p>
            </section>
